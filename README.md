...
- **CI** (`.github/workflows/ci.yml`): formato, lint, tipos, build, pruebas, `npm audit`, `gitleaks`, CodeQL, mapa del código y pruebas de navegador. CodeQL requiere activar Code scanning en el repositorio.
...
- Activar Code scanning para que CodeQL deje de fallar.
