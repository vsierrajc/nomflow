...
| **Salud del sistema**          | `/admin/salud`: estado de Garage (accesibilidad y espacio libre), PostgreSQL (latencia), errores de descarga de documentos y correo; alertas de aviso/crítico con historial y correo a los administradores; umbrales, intervalo y reenvío administrables. Variables: `GARAGE_ADMIN_ENDPOINT`, `GARAGE_ADMIN_TOKEN`, `HEALTH_MONITOR=off` para desactivar el ciclo.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| **Archivo histórico**          | `/admin/archivo`: copia a un bucket de Google Cloud Storage (API S3 interoperable) los certificados y constancias con más de un año, verifica la copia y libera el espacio local; lo histórico se consulta de forma transparente (con aviso de demora). Ver [ADR-004](docs/decisions/ADR-004-archivo-historico-nube.md).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| **Bandeja y avisos del flujo** | `/bandeja`: actividades pendientes de cada usuario y avance de sus solicitudes por pasos, con insignia en el menú. `/admin/notificaciones`: correos al jefe, al aprobador final y al empleado, y recordatorio a los 3 días (configurable).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| **Certificado laboral**        | `/certificado-laboral`: el empleado genera al momento su certificado (general o dirigido, según lo que decida el administrador). `/admin/certificado-laboral`: modalidad, código/versión/fecha del formato de calidad, pie con datos de la empresa y texto del certificado en plantillas versionadas con vista previa. `/admin/certificados-emitidos`: historial de todas las solicitudes. El certificado va firmado por el firmante designado (`/firma-certificados`: cada persona carga su firma y autoriza su uso). Ver [ADR-005](docs/decisions/ADR-005-certificado-laboral-autoservicio.md).                                                                                                                                                                                                                                                                        |
| **Registros y depuración**     | `/admin/registros`: resumen de la auditoría, exportación (CSV/JSONL), envío cifrado al histórico en Google, depuración por fecha y tipo (copiando antes por omisión, con motivo y confirmación), política de retención con ejecución diaria opcional y gestión de los archivos de registro de la aplicación (ver, descargar, enviar, vaciar). Ver [ADR-006](docs/decisions/ADR-006-gestion-de-registros.md).                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
