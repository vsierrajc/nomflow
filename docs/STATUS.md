...
| Certificado laboral de autoservicio (plantillas, historial, código de formato) | DONE | (este PR) | Confirmar ciudad, pie, firmante y código del formato; firma y validación pública como mejora |
